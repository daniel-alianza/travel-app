  ...
  return (
    <section className="group/card mb-8 rounded-3xl border-2 border-border/70 bg-linear-to-br from-card/95 via-card/80 to-card/70 p-4 shadow-xl shadow-primary/10 backdrop-blur-md transition-all delay-75 duration-700 ease-out hover:border-primary/25 hover:shadow-2xl hover:shadow-primary/15 sm:p-6">
      ...
      <div className="mt-5 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div className="grid w-full gap-4 sm:max-w-xl sm:grid-cols-2">
          <div className="space-y-2">
            ...
            <Input
              ...
              disabled={ocupado}
              className="h-11 cursor-pointer rounded-2xl border-2 bg-background/80 transition-all duration-300 focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-primary/20 disabled:cursor-not-allowed"
            />
          </div>
          <div className="space-y-2">
            <Label
