  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl w-full max-w-md px-4 sm:px-6">
        <DialogHeader className="space-y-4 pb-2 text-center sm:text-left">
        ...
        <div className="grid gap-4 sm:gap-5 py-8">
          <Button
            variant="outline"
          ...
          >
            ...
            <div className="flex-1 w-full text-left space-y-1">
              <p className="font-bold text-lg sm:text-xl mb-1 group-hover:text-primary transition-colors">
            ...
            <ArrowRight className="h-6 w-6 text-muted-foreground group-hover:text-primary group-hover:translate-x-2 transition-all self-end sm:self-center sm:ml-auto" />
          </Button>
          ...
          >
            ...
            <div className="flex-1 w-full text-left space-y-1">
              <p className="font-bold text-lg sm:text-xl mb-1 group-hover:text-primary transition-colors">Mis Comprobaciones</p>
