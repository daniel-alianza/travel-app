        ...
        <div className='relative'>
          <Select
            ...
            options={[
              ...
              { value: 'fg', label: 'Grupo FG' },
              { value: 'otros', label: 'Otros' },
            ]}
            className='pl-10 sm:pl-12 pr-10 sm:pr-12 py-2.5 border border-primary rounded-lg text-sm sm:text-base bg-white text-foreground font-medium hover:border-primary hover:shadow-md w-full sm:w-auto text-base lg:text-lg shadow-sm'
          />
