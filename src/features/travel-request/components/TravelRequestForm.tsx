          ...
          >
            {mostrarSoloResumen ? (
              ...
              >
                ...
                <TravelRequestTripSection model={model} tripIndex={tripIndex} />
                <TravelRequestExpensesSection model={model} tripIndex={tripIndex} />
                <TravelRequestObjectivesSection
                  model={model}
                  tripIndex={tripIndex}
                />
                <TravelRequestGasolineSection model={model} tripIndex={tripIndex} />
                <TravelRequestTagSection model={model} tripIndex={tripIndex} />
